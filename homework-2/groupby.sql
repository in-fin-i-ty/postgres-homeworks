...
-- 3. фамилию и телефон сотрудников, у которых в данных отсутствует регион (см таблицу employees) (на скриншоте результата к данному заказу показано имя сотрудника, код написан с ориентировкой на результат в скриншоте)
